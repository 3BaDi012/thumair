-- Ensure bucket exists (0005 insert can be skipped if migration wasn't applied, or can fail on some platform schemas).
...
-- Policies (same as 0005; drop/create so this migration alone fixes Storage + RLS)
