...
import { Heart, ShoppingCart, LogOut, User, Package } from 'lucide-react';
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">مشتري</p>
              </div>
            </button>
      ...
      <div className="flex">
        <aside className="w-64 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 min-h-[calc(100vh-73px)] p-4">
          <nav className="space-y-2">
            ...
            <button
              onClick={() => setIsProfileOpen(true)}
              className="w-full flex items-center gap-3 px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 hover:text-emerald-600 dark:hover:text-emerald-400 rounded-lg transition text-right"
            >
